        ...
        <div className="flex flex-1 flex-col w-full gap-6">
            ...
            <div className='comment-bar w-full flex flex-col gap-6 mx-auto max-w-screen-xl'>
                <div className='comment-header w-full flex items-center gap-4'>
                    <h2 className='text-2xl text-[var(--text-color-primary)] dark:text-gray-50'>Comment</h2>
                ...
                <div className='comment-area w-full flex max-md:flex-col max-md:items-start items-center gap-6 xl:pl-4'>
                    ...
                    <div className="relative w-full">
                        <input
                            id="hs-textarea-ex-2"
                            className="p-4 pb-12 block w-full bg-gray-100 border-gray-200 rounded-lg text-sm outline-none dark:bg-neutral-700 dark:text-white"
                        ...
                        />
                        {/* Toolbar */}
                        <div className="absolute bottom-px inset-x-px p-2 rounded-b-md bg-gray-100 dark:bg-neutral-700">
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    type="button"
                                    className="inline-flex shrink-0 justify-center items-center size-8 rounded-lg text-gray-500 hover:bg-gray-100 focus:z-10 focus:outline-none focus:bg-gray-100 transition-colors"
                                >
                                    <svg
                                    className="shrink-0 size-4"
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <button
                                    type="button"
                                    className="inline-flex shrink-0 justify-center items-center size-8 rounded-lg text-white bg-orange-500 hover:bg-orange-600 focus:z-10 focus:outline-none transition-colors"
                                ...
                                <div className="flex-grow">
                                    <div>
                                        <div className="flex items-center justify-between mb-4">
                                            <div>
                                                <div className="text-sm font-semibold dark:text-gray-50">{ comment.name }</div>
                                                <div className="text-sm text-gray-500">
                                                    Commented on Oct 23, 2020 at 3:19pm
                                                </div>
                                            </div>
                                        </div>
                                        <p className='text-[var(--text-color-primary)] dark:text-gray-50'>
                                            { comment.content }
                                        </p>
                                        <div className="flex gap-2 mt-4">
                                            <button className="py-1.5 px-3 text-gray-950 dark:text-gray-50 hover:scale-105 hover:shadow text-center border border-gray-300 rounded-md h-8 text-sm flex items-center gap-1 lg:gap-2 transition-all">
