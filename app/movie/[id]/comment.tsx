...
export default function CommentDetail()
{
    ...
    return (
        <>
            <div className='comment-bar flex flex-col gap-6 mx-auto mt-6 max-w-screen-2xl'>
                <div className='comment-header w-full flex items-center gap-4'>
                    <h2 className='text-2xl text-[var(--text-color-primary)]'>Comment</h2>
                    <span className='text-base text-[var(--text-color-secondary)]'>2</span>
                </div>
                <div className='comment-area w-full flex max-md:flex-col max-md:items-start items-center gap-4 px-2'>
            ...
            <div className="flex flex-col w-full mx-auto mt-8 px-8 max-w-screen-2xl min-h-40">
                <div className="flex mt-10">
                    <div className="flex flex-col mr-4">
                        <div className="relative mb-3">
                            <div className="h-12 w-12 bg-gray-100 rounded-full overflow-hidden">
                                <img
                                    src="https://tinyfac.es/data/avatars/A7299C8E-CEFC-47D9-939A-3C8CA0EA4D13-200w.jpeg"
                                    className="h-full w-full object-cover"
                                />
                            </div>
                        </div>
                    ...
                    <div className="flex-grow">
                        <div>
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    <div className="text-sm font-semibold">Sandra Comper</div>
                            ...
                            <p className='text-[var(--text-color-primary)]'>
                                ...
                                aliquam, vel veritatis, et nostrum explicabo beatae provident ipsa
                                nemo qui, est nesciunt itaque?
                            </p>
                            <div className="flex gap-2 mt-4">
                                <button className="py-1.5 px-3 hover:text-green-600 hover:scale-105 hover:shadow text-center border border-gray-300 rounded-md h-8 text-sm flex items-center gap-1 lg:gap-2">
